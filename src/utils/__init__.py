...
class Normalizer:
    ...
    def _get_normalizer(self, dataset):
        if dataset == "CIFAR10":
            ...
            std = torch.FloatTensor([0.247, 0.243, 0.261])
        elif dataset == "CIFAR100":
            mean = torch.FloatTensor([0.5071, 0.4865, 0.4409])
            std = torch.FloatTensor([0.2673, 0.2564, 0.2762])
